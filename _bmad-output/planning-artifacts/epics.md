...
*   **Epic Goal:** Người dùng thực hiện nghiên cứu chuyên sâu bằng cách đối chiếu chéo (cross-reference) và tổng hợp nhiều bài báo khoa học cùng lúc, hoặc chọn các chủ đề học thuật để AI Agent tự động viết bài nghiên cứu chất lượng cao có kèm hình ảnh.
...
### Story 5.1: Đối chiếu & Tổng hợp chéo nhiều PDF (Cross-Paper Multi-PDF Synthesis & Chat)
As a nhà nghiên cứu khoa học viết Literature Review,
I want chọn nhiều bài báo đã dịch để tạo báo cáo so sánh và chat chéo giữa chúng,
So that tôi tìm ra điểm tương đồng và khác biệt giữa các công trình nghiên cứu.

**Acceptance Criteria:**
- **Given** Người dùng đang ở trang Thư viện cá nhân (`/library`),
- **When** Người dùng tích chọn 3 bài báo và bấm nút "Tổng hợp liên bài viết" (Synthesize Papers),
- **Then** Hệ thống gửi yêu cầu lên Backend. Backend sử dụng Gemini 1.5 Pro với context lớn để đọc nội dung của cả 3 bài báo và sinh ra một báo cáo tổng hợp (Synthesis Report) so sánh phương pháp nghiên cứu, kết quả và hạn chế của từng bài dưới dạng bảng đối chiếu song ngữ.
- **And** Workspace mở ra một giao diện chat đặc biệt, nơi câu hỏi RAG sẽ tự động truy vấn vector từ Qdrant Cloud trên phạm vi của cả 3 `jobId` đã chọn, hiển thị rõ câu trả lời được lấy từ nguồn bài báo nào.
...
- **And** Hiển thị bài viết đẹp mắt trên giao diện đọc tương tác, tự động lưu bài viết này vào mục "Bài viết khám phá" trong Thư viện cá nhân của người dùng để đọc lại sau này.
